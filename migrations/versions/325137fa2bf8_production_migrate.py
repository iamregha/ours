...
Revision ID: 325137fa2bf8
Revises: 
Create Date: 2024-08-07 00:23:18.298823
...
def upgrade():
    ...
    sa.Column('profile_pic', sa.String(length=600), nullable=True),
    ...
    sa.Column('post_image', sa.String(length=500), nullable=True),
    sa.Column('publish', sa.Integer(), nullable=True),
    sa.Column('popular_view', sa.Integer(), nullable=True),
